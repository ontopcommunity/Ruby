...
from tiensiteo.helper import is_url, progress_for_pyrogram, take_ss
from tiensiteo.helper.localization import use_chat_lang
from tiensiteo.helper.pyro_progress import humanbytes

LOGGER = getLogger("TienSiTeo")

__MODULE__ = "CôngCụMedia"
__HELP__ = """
<blockquote>/genss [trả lời video] - Tạo ảnh chụp màn hình từ video. (Hỗ trợ TG Media và URL trực tiếp)
/mediainfo [link/trả lời tới TG Video] - Nhận Mediainfo từ tập tin.</blockquote>
"""
