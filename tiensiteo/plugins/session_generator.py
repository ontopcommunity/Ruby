...
from tiensiteo.vars import API_HASH, API_ID, COMMAND_HANDLER

LOGGER = getLogger("TienSiTeo")

__MODULE__ = "TạoPhiên"
__HELP__ = """
<blockquote>/genstring - Tạo phiên chuỗi bằng bot này. Chỉ hỗ trợ Pyrogram v2 và Telethon.</blockquote>
"""
