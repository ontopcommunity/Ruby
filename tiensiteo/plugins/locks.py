...
from tiensiteo.helper.functions import get_urls_from_text
...
__MODULE__ = "SửaQuyền"
__HELP__ = """
<blockquote>/lock| /unlock | /locks [Không cần tham số]
...
Bạn chỉ có thể sử dụng tham số "all" với lệnh /lock, không thể dùng với lệnh /unlock
