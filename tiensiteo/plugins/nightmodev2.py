...
from tiensiteo import BOT_NAME, app, scheduler
from tiensiteo.core.decorator import permissions
from tiensiteo.core.decorator.permissions import require_admin
from tiensiteo.helper.localization import langdict, use_chat_lang
from tiensiteo.vars import COMMAND_HANDLER, LOG_CHANNEL, TZ

LOGGER = getLogger("TienSiTeo")

__MODULE__ = "ChếĐộNghỉ"
__HELP__ = """
<blockquote><b>Bật hoặc tắt chế độ ban đêm (khóa cuộc trò chuyện vào các khoảng thời gian cụ thể hàng ngày)</b>
<b>Các cờ:</b>
'-s': "Chỉ định thời gian bắt đầu theo định dạng 24 giờ."
'-e': "Chỉ định khoảng thời gian theo giờ / phút"
'-d': "Tắt chế độ ban đêm cho cuộc trò chuyện."
